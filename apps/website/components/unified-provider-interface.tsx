  ...
  return (
    <div className="w-full">
      ...
      {providers.map((provider) => (
        <div 
          key={provider.slug} 
          className={`${activeTab === provider.slug ? 'block' : 'hidden'}`}
        >
                ...
                <div>
                  ...
                  <Tabs defaultValue="npm" className="w-full">
                    ...
                    <TabsContent value="npm" className="mt-3">
                      <CodeBlock language="bash" code={`npm install ${provider.slug}`} />
                    </TabsContent>
                    <TabsContent value="yarn" className="mt-3">
                      <CodeBlock language="bash" code={`yarn add ${provider.slug}`} />
                    </TabsContent>
                    <TabsContent value="pnpm" className="mt-3">
                      <CodeBlock language="bash" code={`pnpm add ${provider.slug}`} />
                    </TabsContent>
                  </Tabs>
                </div>
                <div>
