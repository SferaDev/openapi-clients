...
export const listAgentRunners = (
  variables: ListAgentRunnersVariables,
  signal?: AbortSignal,
) =>
  fetch<
...
export const createAgentRunner = (
  variables: CreateAgentRunnerVariables,
  signal?: AbortSignal,
) =>
  fetch<
...
export const getAgentRunner = (
  variables: GetAgentRunnerVariables,
  signal?: AbortSignal,
) =>
  fetch<
...
export const updateAgentRunner = (
  variables: UpdateAgentRunnerVariables,
  signal?: AbortSignal,
) =>
  fetch<
...
export const deleteAgentRunner = (
  variables: DeleteAgentRunnerVariables,
  signal?: AbortSignal,
) =>
  fetch<
    undefined,
    DeleteAgentRunnerError,
    undefined,
    {},
    {},
...
export const archiveAgentRunner = (
  variables: ArchiveAgentRunnerVariables,
  signal?: AbortSignal,
) =>
  fetch<
    undefined,
    ArchiveAgentRunnerError,
    undefined,
    {},
    {},
...
export const getAIGatewayProviders = (
  ...
  fetch<
    ...
    GetAIGatewayProvidersError,
    undefined,
    {},
    {},
    {}
  >({ url: "/ai-gateway/providers", method: "get", ...variables, signal });
 ...
 */
export const getAIGatewayToken = (
  variables: GetAIGatewayTokenVariables,
  signal?: AbortSignal,
) =>
  fetch<
  ...
  >({
    url: "/api/v1/sites/{siteId}/ai-gateway/token",
    method: "get",
    ...variables,
    signal,
  });
