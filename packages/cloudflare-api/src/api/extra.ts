...
export const operationsByPath = {
  ...
  'POST /{accountId}/events': postEventList,
  'GET /{accountId}/events/attackers': getAttackerList,
  'GET /{accountId}/events/categories': getCategoryList,
  'POST /{accountId}/events/categories/create': postCategoryCreate,
  'DELETE /{accountId}/events/categories/{categoryId}': deleteCategoryDelete,
  'GET /{accountId}/events/categories/{categoryId}': getCategoryRead,
  'POST /{accountId}/events/categories/{categoryId}': postCategoryUpdate,
  'GET /{accountId}/events/countries': getCountryRead,
  'POST /{accountId}/events/create': postEventCreate,
  'POST /{accountId}/events/create/bulk': postEventCreateBulk,
  'GET /{accountId}/events/cron': getCronUpdateRead,
  'POST /{accountId}/events/cron': postCronUpdate,
  'GET /{accountId}/events/dataset': getDatasetList,
  'POST /{accountId}/events/dataset/create': postDatasetCreate,
  'GET /{accountId}/events/dataset/{datasetId}': getDatasetRead,
  'POST /{accountId}/events/dataset/{datasetId}': postDatasetUpdate,
  'GET /{accountId}/events/raw/{datasetId}/{eventId}': getEventRawReadDS,
  'DELETE /{accountId}/events/relate/{eventId}': deleteEventReferenceDelete,
  'POST /{accountId}/events/relate/{eventId}': postEventReferenceCreate,
  'DELETE /{accountId}/events/tag/{eventId}': deleteEventTagDelete,
  'POST /{accountId}/events/tag/{eventId}': postEventTagCreate,
  'POST /{accountId}/events/tags/create': postTagCreate,
  'GET /{accountId}/events/targetIndustries': getTargetIndustryList,
  'DELETE /{accountId}/events/{eventId}': deleteEventDelete,
  'GET /{accountId}/events/{eventId}': getEventRead,
  'POST /{accountId}/events/{eventId}': postEventUpdate,
  'POST /{accountId}/events/{eventId}/insight/create': postEventInsightCreate,
  'DELETE /{accountId}/events/{eventId}/insight/{insightId}': deleteEventInsightDelete,
  'GET /{accountId}/events/{eventId}/insight/{insightId}': getEventInsightRead,
  'POST /{accountId}/events/{eventId}/insight/{insightId}': postEventInsightUpdate,
  'GET /{accountId}/events/{eventId}/raw/{rawId}': getEventRawRead,
  'POST /{accountId}/events/{eventId}/raw/{rawId}': postEventRawUpdate,
  'GET /{accountId}/version': getVersion
};
