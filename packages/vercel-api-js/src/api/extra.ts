import {
  ...
  updateCheck,
  rerequestCheck,
  deleteDataCachePurgeAll,
  patchDataCacheBillingSettings,
...
export const operationsByPath = {
  ...
  'DELETE /data-cache/purge-all': deleteDataCachePurgeAll,
  'PATCH /data-cache/billing-settings': patchDataCacheBillingSettings,
