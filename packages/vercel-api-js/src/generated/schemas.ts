...
export const flagJSONValueSchema = z.union([z.boolean(), z.array(z.unknown()), z.string(), z.number(), z.object({}).catchall(z.unknown())]).nullable()
...
export const edgeConfigItemValueSchema = z.union([z.boolean(), z.array(z.unknown()), z.string(), z.number(), z.object({}).catchall(z.unknown())]).nullable()
    ...
    payload: z
      .union([
              ...
              teams: z
                .array(
                  z.object({
                    ...
                    createdAt: z.number(),
                    teamId: z.string(),
                    role: z.enum(['OWNER', 'MEMBER', 'DEVELOPER', 'SECURITY', 'BILLING', 'VIEWER', 'VIEWER_FOR_PLUS', 'CONTRIBUTOR']),
                    confirmed: z.boolean(),
                    confirmedAt: z.number(),
                    accessRequestedAt: z.number().optional(),
                    teamRoles: z.array(z.enum(['OWNER', 'MEMBER', 'DEVELOPER', 'SECURITY', 'BILLING', 'VIEWER', 'VIEWER_FOR_PLUS', 'CONTRIBUTOR'])).optional(),
                    teamPermissions: z
                      .array(
                        z.enum([
                          'CreateProject',
        ...
        z.object({
          budget: z
            .object({
              ...
              pricingPlan: z.enum(['plus', 'legacy', 'unbundled']).describe('The acive pricing plan the team is billed with').optional(),
        ...
        z.object({
          ...
          scope: z.string(),
          authMethod: z.enum(['email', 'saml', 'app', 'github', 'gitlab', 'bitbucket', 'manual', 'passkey', 'otp', 'sms', 'invite', 'google']),
        }),
      ])
      .optional(),
  })
  ...
  .object({
        ...
        roles: z
          ...
          .catchall(
            z.union([
              ...
              z.enum(['OWNER', 'MEMBER', 'DEVELOPER', 'SECURITY', 'BILLING', 'VIEWER', 'VIEWER_FOR_PLUS', 'CONTRIBUTOR']),
            ]),
          )
          .describe(
    ...
    membership: z
      .object({
        ...
        confirmed: z.boolean(),
        accessRequestedAt: z.number().optional(),
        role: z.enum(['BILLING', 'CONTRIBUTOR', 'DEVELOPER', 'MEMBER', 'OWNER', 'SECURITY', 'VIEWER', 'VIEWER_FOR_PLUS']),
        teamRoles: z.array(z.enum(['BILLING', 'CONTRIBUTOR', 'DEVELOPER', 'MEMBER', 'OWNER', 'SECURITY', 'VIEWER', 'VIEWER_FOR_PLUS'])).optional(),
        teamPermissions: z
          .array(
            z.enum([
              'CreateProject',
...
export const teamLimitedSchema = z
  ...
  .describe('A limited form of data representing a Team, due to the authentication token missing privileges to read the full Team data.')
        ...
        z.union([
          z.object({
            ...
            sudo: z
              ...
              .optional(),
            origin: z.enum(['saml', 'github', 'gitlab', 'bitbucket', 'email', 'manual', 'passkey', 'otp', 'sms', 'invite', 'google', 'app']).optional(),
            createdAt: z.number(),
...
export const authUserLimitedSchema = z
  ...
  .describe('A limited form of data for the currently authenticated User, due to the authentication token missing privileges to read the full User data.')
...
export const fileTreeSchema = z
  .object({
    ...
    children: z.array(z.unknown()).describe('The list of children files of the directory (only valid for the `directory` type)').optional(),
...
export const getDomainConfigQueryParamsSchema = z
  .object({
    projectIdOrName: z
      .string()
      .describe('The project id or name that will be associated with the domain. Use this when the domain is not yet associated with a project.')
      .optional(),
    strict: z
      .enum(['true', 'false'])
      .describe(
...
export const getProjectsQueryParamsSchema = z
  .object({
    ...
    elasticConcurrencyEnabled: z.enum(['1', '0']).describe('Filter results by projects with elastic concurrency enabled').optional(),
    teamId: z.string().describe('The Team identifier to perform the request on behalf of.').optional(),
    slug: z.string().describe('The Team slug to perform the request on behalf of.').optional(),
  })
  .optional()
