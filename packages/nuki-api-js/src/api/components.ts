...
export type PostAccountSubscriptionPayResourceError = Fetcher.ErrorWrapper<undefined>;

export type PostAccountSubscriptionPayResourceVariables = FetcherExtraProps;

export const postAccountSubscriptionPayResource = (
  variables: PostAccountSubscriptionPayResourceVariables,
  signal?: AbortSignal
) =>
  fetch<string, PostAccountSubscriptionPayResourceError, undefined, {}, {}, {}>({
...
export type PostAccountSubscriptionActivateResourcePathParams = {
  /**
...
export type PostAccountSubscriptionActivateResourceError = Fetcher.ErrorWrapper<undefined>;

export type PostAccountSubscriptionActivateResourceVariables = {
  pathParams: PostAccountSubscriptionActivateResourcePathParams;
} & FetcherExtraProps;

export const postAccountSubscriptionActivateResource = (
  variables: PostAccountSubscriptionActivateResourceVariables,
  signal?: AbortSignal
) =>
  fetch<
    undefined,
    PostAccountSubscriptionActivateResourceError,
    undefined,
    {},
    {},
    PostAccountSubscriptionActivateResourcePathParams
  >({ url: '/account/subscription/{id}/activate', method: 'post', ...variables, signal });

export type PostAccountSubscriptionTerminateResourcePathParams = {
  /**
   * The account subscription unique id
   */
  id: string;
...
export type PostAccountSubscriptionTerminateResourceError = Fetcher.ErrorWrapper<undefined>;

export type PostAccountSubscriptionTerminateResourceVariables = {
  pathParams: PostAccountSubscriptionTerminateResourcePathParams;
} & FetcherExtraProps;

export const postAccountSubscriptionTerminateResource = (
  variables: PostAccountSubscriptionTerminateResourceVariables,
  signal?: AbortSignal
) =>
  fetch<
    undefined,
    PostAccountSubscriptionTerminateResourceError,
    undefined,
    {},
    {},
    PostAccountSubscriptionTerminateResourcePathParams
  >({ url: '/account/subscription/{id}/terminate', method: 'post', ...variables, signal });
...
export type GetAccountSubscriptionsResourceError = Fetcher.ErrorWrapper<undefined>;

export type GetAccountSubscriptionsResourceResponse = Schemas.AccountSubscription[];

export type GetAccountSubscriptionsResourceVariables = FetcherExtraProps;

export const getAccountSubscriptionsResource = (
  variables: GetAccountSubscriptionsResourceVariables,
  signal?: AbortSignal
) =>
  fetch<GetAccountSubscriptionsResourceResponse, GetAccountSubscriptionsResourceError, undefined, {}, {}, {}>({
...
export type GetSubscriptionsResourceError = Fetcher.ErrorWrapper<undefined>;

export type GetSubscriptionsResourceResponse = Schemas.Subscription[];

export type GetSubscriptionsResourceVariables = FetcherExtraProps;

export const getSubscriptionsResource = (variables: GetSubscriptionsResourceVariables, signal?: AbortSignal) =>
  fetch<GetSubscriptionsResourceResponse, GetSubscriptionsResourceError, undefined, {}, {}, {}>({
    url: '/subscription',
    method: 'get',
    ...variables,
    signal
...
export type GetSubscriptionResourcePathParams = {
  /**
   * The subscription id
   */
...
export type GetSubscriptionResourceError = Fetcher.ErrorWrapper<undefined>;

export type GetSubscriptionResourceVariables = {
  pathParams: GetSubscriptionResourcePathParams;
} & FetcherExtraProps;

export const getSubscriptionResource = (variables: GetSubscriptionResourceVariables, signal?: AbortSignal) =>
  fetch<Schemas.Subscription, GetSubscriptionResourceError, undefined, {}, {}, GetSubscriptionResourcePathParams>({
